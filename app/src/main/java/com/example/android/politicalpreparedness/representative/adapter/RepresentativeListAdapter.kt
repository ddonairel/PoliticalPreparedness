...
class RepresentativeListAdapter(OnClickListener: RepresentativeViewHolder.RepresentativeListener) :
    ListAdapter<Representative, RepresentativeViewHolder>(RepresentativeViewHolder) {
